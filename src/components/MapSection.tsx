    ...
    <div className="container max-w-4xl">
      <ScrollReveal>
        ...
        <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground text-center mb-12">
          Parque <span className="text-primary">Ibirapuera</span>
        </h2>
      </ScrollReveal>
      ...
      <ScrollReveal delay={100}>
        <div className="glass-card neon-border rounded-lg overflow-hidden mb-8">
          <iframe
            ...
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3656.6674!2d-46.6576!3d-23.5874!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce59f1c0c1b3a1%3A0x4e7e4e4e4e4e4e4e!2sParque%20Ibirapuera!5e0!3m2!1spt-BR!2sbr!4v1"
            width="100%"
            height="350"
      ...
      <ScrollReveal delay={200}>
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <a
            href="https://maps.google.com/?q=Parque+Ibirapuera+Portao+10"
            target="_blank"
            rel="noopener noreferrer"
